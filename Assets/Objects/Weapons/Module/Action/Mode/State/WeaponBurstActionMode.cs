...
namespace Game
{
    public class WeaponBurstActionMode : Weapon.Module, WeaponConstraint.IInterface, WeaponAction.IOverride, WeaponActionMode.IState
    {
        [SerializeField]
        ...
        protected virtual void End()
        {
            ...
            Weapon.StartCoroutine(Procedure());
